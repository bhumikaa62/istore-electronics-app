                    ...
                    <div className="row p-5">
                        ...
                        <div className="col-lg-6 mb-0 d-flex align-items-center">
                            <div className="text-align-left align-self-center">
                                <h1 className="h1 text-success"><b>iStore</b> electronic</h1>
                                <h3 className="h2">Tiny and Perfect electronic Website</h3>
                                <p>
                                    Zay Shop is an electronic HTML5 CSS website with latest version of Bootstrap 5 (beta 1). 
                                    This Website is 100% free provided by <a rel="sponsored" className="text-success" href="https://templatemo.com" target="_blank">TemplateMo</a> website. 
